...
if __name__ == "__main__":
    ...
    if resModified:
        ...
        aaptargs.append('-S')
        aaptargs.append(os.path.join(exporesdir, 'com.android.support/appcompat-v7/22.2.0/res'))
        aaptargs.append('-S')
        aaptargs.append(os.path.join(exporesdir, 'com.facebook.fresco/drawee/0.4.0/res'))
        aaptargs.append('-S')
        aaptargs.append(os.path.join(exporesdir, 'com.github.johnkil.android-progressfragment/progressfragment/1.4.0/res'))
